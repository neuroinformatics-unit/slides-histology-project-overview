...
- Cloud optimised storage format (Zarr)
- Define atlas as a small config (YAML) file
- Allow template and annotation images to be reused across atlases
- Support custom user atlases (as long as they're in the same coordinate space)
