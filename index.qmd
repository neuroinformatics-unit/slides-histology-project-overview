---
title: AIND--NIU--IBL retreat
subtitle: Histology at the NIU
execute: 
  enabled: true
format:
    revealjs:
        ...
        footer: "AIND--NIU--IBL retreat | 2025-10-15"
        slide-number: c
        menu:
            numbers: true
        chalkboard: true
...
::::
:::: {.column width=25%}
![Igor Tatarnikov](img/igor_tatarnikov.png)
::::
:::
...
:::::{style="font-size: 70%;"}
- 2D, 3D subvolume and whole brain
- Uses Elastix as the registration backend
- Automatic initialisation using Bayesian Optimisation
:::::
:::
...
## BrainGlobe Atlas API V2 {.incremental .smaller}
- Cloud optimised storage format
- Define atlas as a config (YAML) file
- Allow template and annotation images to be used by multiple atlases
- Support custom user-defined atlases
